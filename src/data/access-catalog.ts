...
export const ACCESS_MODULES: {
  ...
  { href: "/tutorials", label: "Role tutorials", group: "Governance" },
...
export const DEFAULT_ROLE_ACCESS: Record<DemoRole, string[]> = {
  admin: ["*"],
  management: ["*"],
  marketing: ["/marketing", "/crm", "/customers", "/tutorials"],
  sales: ["/crm", "/customers", "/contracts", "/bookings", "/tutorials"],
  booking: ["/bookings", "/customers", "/tracking", "/warehouse", "/tutorials"],
  warehouse: ["/warehouse", "/bookings", "/tracking", "/tutorials"],
  traffic: ["/traffic", "/tracking", "/fleet", "/vendor-costs", "/tutorials"],
  delivery: ["/delivery", "/tracking", "/pod", "/tutorials"],
  pod: ["/pod", "/delivery", "/billing", "/tracking", "/tutorials"],
  support: ["/support", "/customers", "/tracking", "/bookings", "/tutorials"],
  billing: ["/billing", "/pod", "/customers", "/contracts", "/tutorials"],
  collections: ["/receivables", "/billing", "/customers", "/tutorials"],
  fleet: ["/fleet", "/traffic", "/vendors", "/tracking", "/tutorials"],
  procurement: ["/procurement", "/vendors", "/vendor-costs", "/tutorials"],
  hr: ["/hr", "/portals/employee", "/admin", "/tutorials"],
  it: ["/admin", "/audit", "/portals/employee", "/tutorials"],
  legal: ["/compliance", "/contracts", "/audit", "/customers", "/tutorials"],
};
